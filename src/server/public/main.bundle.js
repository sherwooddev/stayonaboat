...
var UpdateBoatComponent = (function () {
    function UpdateBoatComponent(route, location, api) {
        this.route = route;
    ...
    UpdateBoatComponent.prototype.getBoatById = function (id) {
        for (var i = 0; i <= this.boats.length - 1; i++) {
            if (this.boats[i].id === id) {
                return this.boats[i];
            }
        }
...
UpdateBoatComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* ActivatedRoute */]) === "function" && _a || Object, Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__shared_api_service__["a" /* ApiService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__shared_api_service__["a" /* ApiService */]) === "function" && _b || Object])
], UpdateBoatComponent);
